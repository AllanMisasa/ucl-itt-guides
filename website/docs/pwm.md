...
Nu skal vi bruge servomotorer til at lave en "radar"... som egentlig er sonar.
 ...
 Så vi skal bruge vores servo, sammen med vores HC-SR04 sonar, og et 3D print jeg har printet til jer. Det er en holder til sonaren, så den kan sidde på en servo. (Alternativt STL fil klar til 3D print: [https://www.thingiverse.com/thing:35398](https://www.thingiverse.com/thing:35398))
...
### Bibliotek til servostyrin i MicroPython
...
class Servo:
    ...
    def write_us(self, us):
        """Set the signal to be microseconds long. Zero disables it."""
        if us == 0:
            self.pwm.duty(0)
            return
